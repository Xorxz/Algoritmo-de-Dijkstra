...
void dijkstra( int inicial ){
    ...
    printf( "\nDistancias mas cortas iniciando en vertice %d\n\n" , inicial );
    for( int i = 1 ; i <= V ; ++i ){
...
int main(){
    ...
    printf("\nIngrese el numero de vertices y pesos, respectivamente: ");
    scanf("%d %d" , &V , &E );
    printf("\nIngrese la matriz con origen, destino y peso, respectivamente: \n\n");
    while( E-- ){
